...
<template>
  ...
  >
    <Head title="Incident Command login" />
    ...
    <div class="relative z-10 flex min-h-screen items-center justify-center px-4">
      <div class="relative w-full max-w-md">
        ...
        >
          <!-- Mini header to echo TaskFlow identity but for Incident Command -->
          <div class="mb-6 flex items-center justify-between">
            <div>
              ...
              <p class="mt-1 text-xs text-slate-600 dark:text-slate-300">
                Use the same demo credentials as TaskFlow to sign in.
              </p>
            </div>
            <div
          ...
          <form @submit.prevent="submit" class="space-y-4">
            <div>
              ...
              />
              <div v-if="form.errors.email" class="mt-1 text-[11px] text-rose-500 dark:text-rose-400">
                {{ form.errors.email }}
              </div>
            </div>
            ...
            >
              ...
              <p class="mt-2">
                New here?
                <Link
                  href="/incident-command/register"
                  class="font-medium text-emerald-600 hover:text-emerald-500 dark:text-emerald-300 dark:hover:text-emerald-200"
                >
                  Create an Incident Command account
                </Link>
              </p>
